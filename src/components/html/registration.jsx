...
const Registration = () => {
    ...
    let [user, setUser]=useState({'name':'', 'phone':'', 'email':'', 'password':'', 'password_confirmation':'', 'confirm':''})
                ...
                <div className="tablica_individ">
                    ...
                    <form className="row g-3" method='POST'onSubmit={send}>
                        ...
                        <div className="col-md-6">
                            ...
                            <input type="password" class="form-control" id="passwordd" required onChange={(e)=>setUser({...user, password:e.target.value})}/>
                        ...
                        <div className="col-md-6">
                            ...
                            <input type="password" class="form-control" id="password_confirmation" required onChange={(e)=>setUser({...user, password_confirmation:e.target.value})}/>
                        </div>
