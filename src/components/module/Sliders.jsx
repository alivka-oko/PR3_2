...
import Slider_zero from "./slide_zero";
...
const Sliders = () => {
    ...
    return (
        <div id="carouselExampleIndicators" className="carousel carousel-dark slide m-auto bg-info bg-opacity-10 w-75 p-2" data-bs-ride="carousel"
